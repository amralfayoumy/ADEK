...
def render(display_outcome, outcome_display_order):
    ...
    with st.form("predict_form"):
        ...
        a3, a4 = st.columns(2)
        s1_enrolled = a3.number_input("Fall Semester – Units Enrolled", 0, 30, 6)
        s1_approved = a4.number_input("Fall Semester – Units Approved", 0, 30, 5)
        s1_grade = a3.number_input("Fall Semester – Grade (0-20)", 0.0, 20.0, 12.0)
        s1_evals = a4.number_input("Fall Semester – Evaluations", 0, 50, 6)
        s1_no_eval = a3.number_input("Fall Semester – No Evaluations", 0, 30, 0)
        s1_credited = a4.number_input("Fall Semester – Units Credited", 0, 30, 0)

        a5, a6 = st.columns(2)
        s2_enrolled = a5.number_input("Spring Semester – Units Enrolled", 0, 30, 6)
        s2_approved = a6.number_input("Spring Semester – Units Approved", 0, 30, 5)
        s2_grade = a5.number_input("Spring Semester – Grade (0-20)", 0.0, 20.0, 12.0)
        s2_evals = a6.number_input("Spring Semester – Evaluations", 0, 50, 6)
        s2_no_eval = a5.number_input("Spring Semester – No Evaluations", 0, 30, 0)
        s2_credited = a6.number_input("Spring Semester – Units Credited", 0, 30, 0)
