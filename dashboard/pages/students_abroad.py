...
def render(df_full, display_outcome):
    ...
    with tab_overview:
        ...
        r1.plotly_chart(fig_risk_ab, width="stretch")
        ...
        if not drop_ab.empty:
            ...
            st.plotly_chart(fig_reas, width="stretch")
    ...
    with tab_compare:
        ...
        r1.plotly_chart(fig_v1, width="stretch")
    ...
    with tab_uni:
        ...
        st.plotly_chart(fig_uni_ab, width="stretch")
    ...
    with tab_prog:
        ...
        st.plotly_chart(fig_prog_ab, width="stretch")
